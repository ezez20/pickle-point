...
//  pickle point
//
//  Created by Ezra Yeoh on 2/5/24.
//

import UIKit
import AVFoundation

class ScoreBoardVC2: UIViewController {
    ...
    var team1ScoreLabel: UILabel = {
        ...
        label.text = "0"
        label.font = .systemFont(ofSize: 35*2)
        label.transform = CGAffineTransform(rotationAngle: .pi/2)
        label.frame.size = CGSize(width: 30*2, height: 30*2)
        return label
    }()
    ...
    let dashLabel: UILabel = {
        ...
        label.font = .systemFont(ofSize: 35*2)
        label.transform = CGAffineTransform(rotationAngle: .pi/2)
        label.frame.size = CGSize(width: 10*2, height: 10*2)
        return label
    }()
    ...
    let pickleBallImageView: UIImageView = {
        ...
        imageView.frame.size = CGSize(width: 10*2, height: 10*2)
    ...
    let timerLabel: UILabel = {
        ...
        label.textColor = .systemGray
        label.text = "0:00"
        label.font = .systemFont(ofSize: 25*2)
        label.transform = CGAffineTransform(rotationAngle: .pi/2)
    ...
    override func viewDidLoad() {
        ...
        scoreBoardViewFrame.rightAnchor.constraint(equalTo: view.rightAnchor, constant: 0).isActive = true
        scoreBoardViewFrame.heightAnchor.constraint(equalToConstant: 180*2).isActive = true
        scoreBoardViewFrame.widthAnchor.constraint(equalToConstant: 80*2).isActive = true
        ...
        team1ScoreLabel.centerXAnchor.constraint(equalTo: scoreBoardViewFrame.centerXAnchor, constant: 20).isActive = true
        ...
        dashLabel.centerXAnchor.constraint(equalTo: scoreBoardViewFrame.centerXAnchor, constant: 20).isActive = true
        ...
        team2ScoreLabel.centerXAnchor.constraint(equalTo: scoreBoardViewFrame.centerXAnchor, constant: 20).isActive = true
        ...
        pickleBallImageView.centerXAnchor.constraint(equalTo: scoreBoardViewFrame.centerXAnchor, constant: 20).isActive = true
        pickleBallImageView.widthAnchor.constraint(equalToConstant: 20*2).isActive = true
        pickleBallImageView.heightAnchor.constraint(equalToConstant: 20*2).isActive = true
        ...
        currentlyScoringLabel.centerXAnchor.constraint(equalTo: scoreBoardViewFrame.centerXAnchor, constant: 20).isActive = true
        
        // timerLabel
        scoreBoardViewFrame.addSubview(timerLabel)
        timerLabel.translatesAutoresizingMaskIntoConstraints = false
        timerLabel.centerXAnchor.constraint(equalTo: scoreBoardViewFrame.leftAnchor, constant: 28).isActive = true
